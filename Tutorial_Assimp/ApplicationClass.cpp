...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, bool vsyncEnabled, bool fullScreen, float screenDepth, float screenNear)
{
	...
	result = m_AssimpLoader->LoadFile(m_Direct3D->GetDevice(), hwnd, "..\\Data\\Models\\ZombieStay.fbx");//Standing Taunt Battlecry
	if (!result)
	{
...
bool ApplicationClass::Frame()
{
	...
	m_AssimpLoader->Render(m_Direct3D->GetDeviceContext());
